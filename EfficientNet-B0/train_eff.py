...
# Define the EfficientNet_b0 model
class CustomEfficientNetB0(nn.Module):
    def __init__(self, num_classes):
        super(CustomEfficientNetB0, self).__init__()
        self.model = models.efficientnet_b0(weights=None)  # No pre-trained weights
...
if __name__ == "__main__":
    ...
    # Save the model
    torch.save(model.state_dict(), 'efficientnet_b0_custom.pth')
